class BootloaderConfig:
    def __init__(
        ...
        self.kBootloaderSwitchConfigOffset = kBootloaderSwitchConfigOffset
        self.kBootloaderUnlockOffset = kBootloaderUnlockOffset
        self.kBootloaderBitstreamOffset = kBootloaderBitstreamOffset
        self.kSOCBitstreamOffset = kSOCBitstreamOffset
        self.kUserBitstreamOffset = kUserBitstreamOffset
        self.kUserDataOffset = kUserDataOffset
        self.kSerialNumberOffset = kSerialNumberOffset
        self.kSerialNumberSize = kSerialNumberSize
        self.kUUIDOffset = kUUIDOffset
        self.kUUIDSize = kUUIDSize
        self.kBootloaderUnlockWord = kBootloaderUnlockWord
        self.kWamrbootTemplate = kWamrbootTemplate
        self.kBitstreamPrefixStart = kBitstreamPrefixStart
        self.kBitstreamPrefixEnd = kBitstreamPrefixEnd
...
class SocConfig:
    def __init__(
        ...
        self.kMosiBufferSizeBytes = kMosiBufferSizeBytes
        self.kMisoBufferSizeBytes = kMisoBufferSizeBytes
        self.kStatusRegisterOffset = kStatusRegisterOffset
        self.kSOCControlRegisterOffset = kSOCControlRegisterOffset
        self.kCommandRegisterOffset = kCommandRegisterOffset
        self.kMOSIBufferOffset = kMOSIBufferOffset
        self.kMISOBufferOffset = kMISOBufferOffset
